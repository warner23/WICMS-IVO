...
if (isset($_FILES)) {
	if (isset($_FILES['file'])) {
		...
		$imgs     = $dir ."/WIAdmin/WIMedia/Img/avator/" . $userId. '/' .basename($_FILES['file']['name']);
		//echo $imgs;
		$vids     = $dir ."/WIAdmin/WIMedia/Vid/contents/" . basename($_FILES['file']['name']);
		$error    = $_FILES['file']['error'];
		$imgups     = "../WIAdmin/WIMedia/Img/avator/" . $userId. '/' . basename($_FILES['file']['name']);
