...
class WIImage
{
    ...
    public function avatarPics()
        {
            $userId = WISession::get('user_id');
        $dir = dirname(dirname(dirname(dirname(__FILE__)))) . '/WIAdmin/WIMedia/Img/avator/'. $userId.'/';
        $images = scandir($dir);
        ...
        <div class="panel panel-info">
        <div class="panel-heading">' . $value . '</div>
        <div class="panel-body"><img src="../WIAdmin/WIMedia/Img/avator/'. $userId.'/' . $value .'" class="img-responsive" id="' . $value .'" style="width:50px; height:50px;"></div>
        <div class="panel-footer"></div>
        </div></div>';
        }
   ...
   public function avatarDisplayPics()
        {
            $userId = WISession::get('user_id');
        $dir = dirname(dirname(dirname(dirname(__FILE__)))) . '/WIAdmin/WIMedia/Img/avator/'. $userId.'/';
        $images = scandir($dir);
