...
<div class="modal hide" id="modal-'.$ele_id.'-details" tabindex="-1" role="dialog" aria-labelledby="WIModalLabel" aria-hidden="true">
  ...
  {
    echo '<div class="well">
          <button onclick="WIMedia.avatarMedia()">Upload from WIMedia Library</button>
          <button onclick="WIMedia.avatarUpload()">upload from computer</button>
        </div>';
  }
  ...
  public function UploadAvatarPics()
  {
    echo '<div class="col-lg-3 col-md-3 col-sm-2">';
          $this->site->avatarDisplay(); 
          echo '</div>';
  }
