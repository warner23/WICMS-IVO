...
<div class="col-100">Posts</div><!-- end col1-->

</div><!-- end of col-labels-->
<div id="posts"></div>';
if($this->login->isLoggedIn()){
echo '<div><a href="new_post.php"><button class="btn btn-as pull-right" id="post" type="button">Reply</button></a></div>';
}else{
echo '<div>Please login to reply</div>';
...
echo '</div><!-- end of col-cats-->
					...
					<script type="text/javascript" src="WICore/WIJ/posts.js"></script>';
