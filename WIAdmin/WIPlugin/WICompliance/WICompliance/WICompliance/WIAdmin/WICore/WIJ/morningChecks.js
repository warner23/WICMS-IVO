 $(document).ready(function(){
    ...
    $("body").delegate(".dropdown-toggle-addfridge", "click", function(event){
        event.preventDefault();
       // console.log("clicked");
        var expanded = $(".dropdown-toggle-addfridge").attr('dropdown');
        //alert(expanded);
        console.log(expanded);
        if (expanded === "true") {
            $(".dropdown-menu-addfridge").css('display','none');
            $(".dropdown-toggle-addfridge").attr('dropdown', false);
        }else if (expanded === "false"){
            $(".dropdown-menu-addfridge").css('display','block');
            $(".dropdown-toggle-addfridge").attr('dropdown', true);
        }
        });
...
morningChecks.options = function(id){
    $("#fridgeOptions-"+id).toggle('show')
}
...
morningChecks.save = function(){
    ...
    signedOpening   = $('#SignOpeningChecks').val();
    ...
    $('.questions:checked').each(function() {
        var id = $(this).data('id');
        var value = $("#button-indicator-q"+id).val();
        ...
        if(value === "no"){
            ...
            questiondata.push({
    'answer'   : $("#button-indicator-q"+id).val(),
    ...
    fridgeCheck = $("#button-indicator-fc").val();
...
morningChecks.dropdown = function(id){

    var expanded = $(".dropdown-toggle-"+id).attr('dropdown');
        //alert(expanded);
        console.log(expanded);
        if (expanded === "true") {
            $(".dropdown-menu-"+id).css('display','none');
            $(".dropdown-toggle-"+id).attr('dropdown', false);
        }else if (expanded === "false"){
            $(".dropdown-menu-"+id).css('display','block');
            $(".dropdown-toggle-"+id).attr('dropdown', true);
        }
}