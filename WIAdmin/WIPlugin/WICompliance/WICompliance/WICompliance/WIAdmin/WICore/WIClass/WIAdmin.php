...
class WIAdmin
{
    ...
    public function getRole() {
        $result = $this->WIdb->select(
                      "SELECT `wi_compliance_roles`.`role` as role 
                       FROM `wi_staff_roles`,`wi_compliance_staff`
                       WHERE `wi_compliance_staff`.`staff_role` = `wi_staff_roles`.`id`
                       AND `wi_compliance_staff`.`staff_id` = :id",
