  ...
  <div class="collapse navbar-collapse" id="menuNav">
    ...
    <ul class="navbar-nav mr-auto">';
        ...
        if($this->User->isStaff()){
               echo '<li class="nav-item">
            <a class="nav-link" href="../cashposlogin.php">' . WILang::get('Staff_log_in') . '</a></li>
            <li class="nav-item">
            <a class="nav-link" href="index.php">' . WILang::get('compliance') . '</a></li>
            <li class="dropdown" style="padding-top: 13px;">
            <a href="javascript:void(0)" id="specs" class="dropdown-toggle" aria-expanded="false" dropdown="false" data-toggle="dropdown">' . WILang::get('specs') . '</a>
