...
require_once dirname(dirname(dirname(dirname(__FILE__)))) .'/WIClass/WI.php';
require 'autoload.php';
require 'config.php';

use Hybrid\Exception\Exception;
use Hybrid\Hybridauth;
use Hybrid\HttpClient;
use Hybrid\Storage\Session;
