...
class WIImage
{
    ...
    public function UserPostPics()
        {
        $userId = $this->User->id();
        $dir = dirname(dirname(dirname(__FILE__))) . '/WIAdmin/WIMedia/Img/user/'.$userId;
        $images = scandir($dir);
...
public function faviconPics()
        ...
        {
        $dir = dirname(dirname(dirname(__FILE__))) . '/WIMedia/Img/shop/products/';
        $images = scandir($dir);
