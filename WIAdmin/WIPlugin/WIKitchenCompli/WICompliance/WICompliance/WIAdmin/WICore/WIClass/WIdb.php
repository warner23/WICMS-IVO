...
class WIdb extends PDO
{
    ...
    public function selectID($sql, $array)
    {
        $this->WIdb = self::getInstance();
        ...
        foreach ($array as $key => &$value) {
            //echo ":$key", $value;
            $smt->bindParam(":$key", $value, PDO::PARAM_INT);
        }
        ...
        public function Selected($sql, $array,  $while)
    {
        $this->WIdb = self::getInstance();
        ...
        public function selectColumn($sql, $array, $column)
    {
    ...
    public function update($table, $data, $where, $whereBindArray)
    {
        $this->WIdb = self::getInstance();
