...
<?php  $contact = new WIContact();  ?>
                    ...
                    <div class="col-md-3 col-sm-4">
                        ...
                        <div style="margin-top: 15px;">
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li class="active"><a href="#"><i class="fa fa-inbox"></i> Inbox (<?php echo $contact->mailCount(); ?>)</a></li>
       ...
       <!--  <script src="http://ajax.googleapis.com/ajax/libs/jquery/2.0.2/jquery.min.js"></script>
        ...
        <!-- Page script -->
 <script src="WICore/WIJ/WIContact.js" type="text/javascript"></script>
