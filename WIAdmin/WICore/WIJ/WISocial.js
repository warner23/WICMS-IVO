...
$(document).ready(function(event)
{
  ...
  // twitter button
  $(".button-indicator-tw").click(function(){
    var twit = $("#tw-login").attr('value');

    if (twit === "false"){
     $(".button-indicator-tw").css("left", "80px");
      $("#twit").prop("checked", true);
      $("#twit").attr("checked", true);
      $("#twit").prop("checked", "checked");
      $(".button-indicator-tw").addClass("button-indicator-tw-on");
      $("#twittee").removeClass("hide");
   }else if (twit === "true"){
    $(".button-indicator-tw").css("left", "17px");
  ...
  //fb button
    $(".button-indicator-fb").click(function(){
    var twit = $("#fb-login").attr('value');

    if (twit === "false"){
     $(".button-indicator-fb").css("left", "80px");
      $("#twit").prop("checked", true);
      $("#twit").attr("checked", true);
      $("#twit").prop("checked", "checked");
      $(".button-indicator-fb").addClass("button-indicator-tw-fb");
      $("#faceb").removeClass("hide");
   }else if (twit === "true"){
    $(".button-indicator-fb").css("left", "17px");
    $("#twit").prop("checked", false);
    $("#faceb").addClass("hide");
      }
    });
      ...
      //gp button
    $(".button-indicator-gp").click(function(){
    var gp = $("#gp-login").attr('value');

    if (gp === "false"){
     $(".button-indicator-gp").css("left", "80px");
      $("#gp-switch").prop("checked", true);
      $("#gp-switch").attr("checked", true);
      $("#gp-switch").prop("checked", "checked");
      $(".button-indicator-gp").addClass("button-indicator-tw-fb");
      $("#googlep").removeClass("hide");
   }else if (twit === "true"){
    $(".button-indicator-gp").css("left", "17px");
    $("#gp-switch").prop("checked", false);
