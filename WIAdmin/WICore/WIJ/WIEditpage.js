...
WIEditpage.loadMods = function(mod, ele){
        ...
        success: function(result)
        {
            ...
            //alert(res.rsc);
                ...
                if (res.panel > 0) {
                     ...
                     WIEditpage.loadMods("panel", "panel_mod");                  
                }else{
                    $("#panelswitch").prop("unchecked");
                }

                if (res.top_head > 0) {
                     $("#topheadswitch").prop("checked", true); 
                     WIEditpage.loadMods("top_head", "top_head_mod");                  
                }else{
                    $("#topheadswitch").prop("unchecked");
                }

                if (res.header > 0) {
                     $("#headerswitch").prop("checked", true);
                     WIEditpage.loadMods("header", "header_mod");                   
                }else{
                    $("#headerswitch").prop("unchecked");
                }

                if (res.footer > 0) {
                     $("#footerswitch").prop("checked", true);
                     WIEditpage.loadMods("footer", "footer_mod");                   
                }else{
                    $("#footerswitch").prop("unchecked");
                }
