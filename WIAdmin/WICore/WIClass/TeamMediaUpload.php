...
if (isset($_FILES)) {
	if (isset($_FILES['file'])) {
		...
		$imgs     = "../../WIMedia/Img/team/" . basename($_FILES['file']['name']);
		$vids     = "../../WIMedia/Vid/team/" . basename($_FILES['file']['name']);
		$error    = $_FILES['file']['error'];
		$imgups     = "WIMedia/Img/team/" . basename($_FILES['file']['name']);
		$imgThumb     = basename($_FILES['file']['name']);
		$vidslink     = "WIMedia/Vid/team/" . basename($_FILES['file']['name']);
