...
if (isset($_FILES)) {
	if (isset($_FILES['file'])) {
		...
		$imgs     = "../../WIMedia/Img/train/" . basename($_FILES['file']['name']);
		$vids     = "../../WIMedia/Vid/train/" . basename($_FILES['file']['name']);
		$error    = $_FILES['file']['error'];
		$imgups     = "WIMedia/Img/train/" . basename($_FILES['file']['name']);
		$imgThumb     = basename($_FILES['file']['name']);
		$vidslink     = "WIMedia/Vid/train/" . basename($_FILES['file']['name']);
