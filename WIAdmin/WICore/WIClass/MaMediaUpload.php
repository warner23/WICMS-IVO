...
if (isset($_FILES)) {
	if (isset($_FILES['file'])) {
		...
		$imgs     = "../../WIMedia/Img/MMA/" . basename($_FILES['file']['name']);
		$vids     = "../../WIMedia/Vid/MMA/" . basename($_FILES['file']['name']);
		$error    = $_FILES['file']['error'];
		$imgups     = "WIMedia/Img/MMA/" . basename($_FILES['file']['name']);
		$imgThumb     = basename($_FILES['file']['name']);
		$VidThumb     = basename($_FILES['file']['name']);
		$mediaVid   = "WIMedia/Vid/MMA/" . basename($_FILES['file']['name']);
