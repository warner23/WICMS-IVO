...
class WIPagination {        
        ...
        public function __construct()
        {
            ...
            $this->_link          = filter_var(htmlspecialchars($_SERVER['PHP_SELF']));
            $this->_pageNumHtml  = '';
            $this->_itemHtml     = '';
        }
    ...
    public function SlidePagination($ele, $pagin, $class, $item_per_page, $current_page, $total_records, $total_pages)
    {
         $pagination = '';
    ...
    if($total_pages > 0 && $total_pages != 1 && $current_page <= $total_pages){ //verify total pages and current page number
        if ($total_records < $item_per_page) {
            ...
            $pagination .= '<ul class="pagination" id="'. $pagin .'">';
        
        $right_links    = $current_page + 3; 
        $previous       = $current_page - 1 ; //previous link   1
        $next           = $current_page + 1; //next link
        $first_link     = true; //boolean var to decide our first link
        ...
        if($current_page > 1){
            ...
            $pagination .= '<li>
            <a href="javascript:void(0)" id="prev" data-class="'.$class.'" data-pagin="'.$pagin.'" data-ele="'.$ele.'" data-page="'.$previous_link.'" title="Previous" class="prev"><span>
            <img src="../WIAdmin/WIMedia/Img/left_arrow_but.png" class="left_but"> 
            </span> </a>
            </li>'; //previous link
        ...
        if($current_page < $total_pages){ 
            ...
            if($i<=$total_pages){
                ...
                $pagination .= '<li><a href="javascript:void(0)" id="next" data-class="'.$class.'" data-ele="'.$ele.'" data-pagin="'.$pagin.'"  data-page="'.$next.'" data-items="'.$item_per_page.'" data-records="'.$total_records.'" data-total="'.$total_pages.'" title="Next" class="next">  
                    <span>
            <img src="../WIAdmin/WIMedia/Img/right_arrow_but.png" class="right_but"> 
            </span>
                 </a></li>'; //next link
  ...
  public function SlideNextPagination($ele, $pagin,$clas, $item_per_page, $current_page, $total_records, $total_pages)
    {
    ...
    if($total_pages > 0 && $total_pages != 1 && $current_page <= $total_pages){ //verify total pages and current page number
        ...
        if($current_page > 1){
            ...
            $pagination .= '<li>
            <a href="javascript:void(0)" id="prev" data-class="'.$clas.'" data-pagin="'.$pagin.'" data-page="'.$previous_link.'" data-items="'.$item_per_page.'" data-ele="'.$ele.'" data-records="'.$total_records.'" data-total="'.$total_pages.'" title="Previous" class="prev"> 
                <span>
            <img src="../WIAdmin/WIMedia/Img/left_arrow_but.png" class="left_but"> 
            </span>
             </a>
        ...
        $next_link = ($i > $total_pages) ? $total_pages : $i;
        $next = $current_page+1;
        $pagination .= '<li><a href="javascript:void(0)" id="next" data-class="'.$clas.'"  data-page="'.$next.'" data-pagin="'.$pagin.'" data-items="'.$item_per_page.'" data-ele="'.$ele.'" data-records="'.$total_records.'" data-total="'.$total_pages.'" title="Next" class="next"> 
            <span>
            <img src="../WIAdmin/WIMedia/Img/right_arrow_but.png" class="right_but"> 
            </span>
         </a></li>'; //next link
