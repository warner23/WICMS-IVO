	...
	class WIForum
{
	...
	{
		$categories = $this->WIdb->bindfree("SELECT * FROM `wi_forum_categories`");
		$sections = $this->WIdb->bindfree("SELECT * FROM `wi_forum_sections`");
		$posts = $this->WIdb->bindfree("SELECT * FROM `wi_forum_posts`");
...
.ui-tabs-vertical .ui-tabs-nav{
    ...
    {
	  $result = $this->WIdb->bindfree("SELECT * FROM `wi_forum_categories`");
