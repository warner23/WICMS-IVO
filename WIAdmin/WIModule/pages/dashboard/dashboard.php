...
class dashboard
{
    ...
    {
        $page = 'dashboard';
        $heading = $this->escape($this->moduleText($page, 'text', 'Dashboard'));
        $body = $this->escape($this->moduleText($page, 'text1', 'Core WICMS dashboard page.'));
        echo <<<HTML
...
HTML;
    ...
    {
        $this->Boot->startMod($page, 'Dashboard', '<p>Core WICMS dashboard page.</p>');
        ...
        echo '<h1 style="margin:0 0 12px;color:#0f172a;">' . $this->escape('Dashboard') . '</h1>';
        echo '<p style="margin:0;color:#475569;font-size:16px;line-height:1.7;">' . $this->escape('The clean dashboard should load without Compliance classes or industry-pack tables.') . '</p>';
        echo '</section>';
