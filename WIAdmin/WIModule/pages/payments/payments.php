...
final class WIPaymentsModule
{
    public static function moduleMeta(): array { return ['code'=>'payments','name'=>'Payments','type'=>'page','area'=>'member','version'=>'2.0.0','description'=>'Member order/payment history.']; }
    ...
    public function mod_name(string $module = 'payments', string $page = 'payments', array $payload = []): void
    {
        $orders = $this->orders();
        $this->openShell($page);
        echo '<section class="wi-profile-hero wi-profile-hero--compact"><div class="wi-profile-hero__content"><p class="wi-kicker">Payments</p><h2>Payment history</h2><p>Review membership, package and plugin order payments linked to your account.</p></div></section>';
