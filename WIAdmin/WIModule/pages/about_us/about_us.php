...
class about_us
{
    ...
    {
        $page = 'about_us';
        $heading = $this->escape($this->moduleText($page, 'text', 'About WICMS'));
        $body = $this->escape($this->moduleText($page, 'text1', 'A clean WICMS platform page ready for your own theme and content.'));
        echo <<<HTML
...
HTML;
    ...
    {
        $this->Boot->startMod($page, 'About WICMS', '<p>A clean WICMS platform page ready for your own theme and content.</p>');
        ...
        echo '<h1 style="margin:0 0 12px;color:#0f172a;">' . $this->escape('About WICMS') . '</h1>';
        echo '<p style="margin:0;color:#475569;font-size:16px;line-height:1.7;">' . $this->escape('WICMS is the base layer for the wider WI ecosystem. Add plugin and theme folders later, then apply their backend changes through the installer/manager flow.') . '</p>';
        echo '</section>';
