                            ...
                            <form class="form-horizontal">
                                <div class="form-group mb-3">
                                    <div class="input-group input-group-alternative">
                                        ...
                                        <input class="form-control" required name="cashier_email" placeholder="Email" type="email" id="admin_email">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group input-group-alternative">
                                        ...
                                        <input class="form-control" required name="cashier_password" id="admin_password" placeholder="Password" type="password">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="text-left">
                                        <button  name="login" id="admin_btn_login" class="btn btn-primary my-4">Log In</button>
