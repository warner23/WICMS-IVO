                            ...
                            <form class="form-horizontal">
                                <div class="form-group mb-3">
                                    <div class="input-group input-group-alternative">
                                        ...
                                        <input class="form-control" required name="staff_email" placeholder="Email" type="email" id="staff_email">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group input-group-alternative">
                                        ...
                                        <input class="form-control" required name="staff_password" placeholder="Password" type="password" id="staff_password">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="text-left">
                                        <button name="login" class="btn btn-primary my-4" id="staff_btn_login">Log In</button>
