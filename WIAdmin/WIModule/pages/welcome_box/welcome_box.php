...
class welcome_box
{
    ...
    {
        $page = 'welcome_box';
        $heading = $this->escape($this->moduleText($page, 'text', 'Welcome to WICMS'));
        $body = $this->escape($this->moduleText($page, 'text1', 'Clean WICMS base install, ready for plugins and themes.'));
        echo <<<HTML
...
HTML;
    ...
    {
        $this->Boot->startMod($page, 'Welcome to WICMS', '<p>Clean WICMS base install, ready for plugins and themes.</p>');
        ...
        echo '<h1 style="margin:0 0 12px;color:#0f172a;">' . $this->escape('Welcome to WICMS') . '</h1>';
        echo '<p style="margin:0;color:#475569;font-size:16px;line-height:1.7;">' . $this->escape('This installation is intentionally generic. Compliance, POS, marketplace, and other industry packs should be added as plugins rather than baked into the base.') . '</p>';
        echo '</section>';
