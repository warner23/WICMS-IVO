			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-8 grid-margin stretch-card">
                       ...
                       <li class="about-items"><i class="mdi mdi-trophy-variant-outline icon-sm "></i><span class="about-item-name">Belts:</span><span class="about-item-detail">
    ...
    float: right;
		...
		<div class="main-panel">
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 grid-margin stretch-card">
						<div class="card">
							<div class="profile-card">
					...
					</div><div class="col-lg-8 col-md-8 col-sm-8 col-xs-8" id="userTabs">';
