...
<div class="center" id="results-lang"></div>
  ...
  public function mod_name($page)
  {
    ...
    if ($left_sidePower > 0) {
      ...
      echo '<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 contact">';
    }else{
  ...
  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
<div id="map" style="height: 538px;border: 2px solid yellow;"></div>
...
function initMap() {
  ...
  const map = new google.maps.Map(document.getElementById("map"), {
    zoom: 14,
    center: { lat: 53.190493, lng: -2.445111 },
    mapTypeId: "terrain"
  });
...
<script
      src="https://maps.googleapis.com/maps/api/js?key='.GOOGLE_MAP_API .'&callback=initMap&libraries=&v=weekly"
      async
    ></script>
  </div>  
