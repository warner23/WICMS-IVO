...
class contact_us
{
    ...
    {
        $page = 'contact_us';
        $heading = $this->escape($this->moduleText($page, 'text', 'Contact'));
        $body = $this->escape($this->moduleText($page, 'text1', 'A clean contact page ready for your own business content.'));
        echo <<<HTML
...
HTML;
    ...
    {
        $this->Boot->startMod($page, 'Contact', '<p>A clean contact page ready for your own business content.</p>');
        ...
        echo '<h1 style="margin:0 0 12px;color:#0f172a;">' . $this->escape('Contact') . '</h1>';
        echo '<p style="margin:0;color:#475569;font-size:16px;line-height:1.7;">' . $this->escape('Use this page as the starting point for enquiries, support, demos, or general website contact details.') . '</p>';
        echo '</section>';
