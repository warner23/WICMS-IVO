    ...
    echo '<div class="flex-center position-ref full-height">
        <div class="content">
            ...
            <div class="links">
                ...
                <a href="WIAdmin/poslogin.php">Managers Log In</a>
                <a href="WICashier/cashposlogin.php">Cashier Log In</a>
              
            </div>
        </div>
    </div>';

    /*  <a href="WICustomer/custposlogin.php">Customer Log In</a>
                <a href="WICustomer/custIndex.php"> Customer</a>*/
