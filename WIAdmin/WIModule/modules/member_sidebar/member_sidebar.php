    ...
    public function mod_name(string $module = '', string $page = 'profile', array $payload = []): void
    {
        ...
        if ($hasCompliance) {
            $this->renderGroup('Business & Compliance', [
                ['checklists', 'My Checklists', 'checklist', $this->rootHref('WIMembers/profile.php'), ['checklists']],
                ...
                ['actions', 'My Actions', 'actions', $this->rootHref('WIMembers/profile.php'), ['actions']],
