...
class Components 
{
    ...
    public function RgroupActions()
  {
    ...
    <button class="btn item_editToggle" type="button" name="edit column">
    <i class="fas fa-edit"></i>    
    </button>
    <button class="btn item_clone" type="button" name="clone column">
    <i class="far fa-copy"></i>
    </button>
    <button class="btn item_remove" type="button" name="delete column">
    <i class="fas fa-times"></i> 
    </button>
    </div>';
  }
