...
$('head link[data-name=layout]').attr('href', 'WITheme/ECMA/site/css/layout/' + layout + '.css');
$(".styleswitcher").attr('id', layout);
}
...
function changeLayout(layout) {
$.cookie(cookieName, layout);
$('head link[data-name=skins]').attr('href', 'WITheme/ECMA/site/css/skins/' + layout + '.css');
$(".styleswitcher").attr('id', layout);
}
